...
message("Simulate Bayesian RAR Grouped Loss - Posterior Mean")
...
print(bayestabrargrp)
# saveRDS(bayestabrargrp, file = file.path("output/expected_losses", "bayestabrargrp.rds"))
