...
message("Simulate Fixed 1:1 Early Stopping Group Loss")
...
run_fixed11grp_prior_bayesloss_chunked <- function(cl,
  ...
  for (z in 1:Z) {
    ...
    for (c in 1:n_chunks) {
      ...
      }, z = z, offset = offset, N = N, K = K, sigma = sigma, I_theta_fix = I_theta_fix, delta = delta, theta_0 = theta_0, theta_tau_0 = theta_tau_0)
...
print(freqtabfixesgrp)
# saveRDS(freqtabfixesgrp,
#         file = file.path("output/expected_losses", "freqtabfixesgrp.rds"))