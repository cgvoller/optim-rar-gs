...
## 
# Simulate RAR Pooled ----------------------------------------------------------
message("Simulate Frequentist RAR Early Stopping Pooled Loss")
simulate_rar_final_loss <- function(K, mu_1, mu_2, sigma, I_theta_fix, delta, theta_0, theta_tau_0) {
...
print(freqtabespl)
#saveRDS(freqtabespl, file = file.path("output/expected_losses", "freqtabespl.rds"))