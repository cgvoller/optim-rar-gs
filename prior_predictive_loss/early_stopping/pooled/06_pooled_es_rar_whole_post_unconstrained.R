...
bayestabrarwpplnegpat <- data.frame(
  prior = 1:nrow(priors),
...
print(bayestabrarwpplnegpat)
# saveRDS(bayestabrarwpplnegpat, file = file.path("output/expected_losses", "bayestabrarwpplnegpat.rds"))
