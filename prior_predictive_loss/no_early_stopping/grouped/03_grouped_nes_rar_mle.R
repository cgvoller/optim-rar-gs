...
##
## Purpose of script: Frequentist RAR MLE with no early stopping
##
## Author: Corey Voller
##
...
message("Simulate Frequentist RAR No Early Stopping Grouped Loss")
...
# Run function
run_rarnsgrp_prior_bayesloss_chunked <- function(cl,
                                                 priors,
                                                 nsims,
                                                 chunk_size = 100000L,
                                                 K = 5L,
...
resgrp <- run_rarnsgrp_prior_bayesloss_chunked(
  cl = cl,
  priors = priors,
  nsims = nsims,
...
print(freqtabrarnsgrp)
# saveRDS(freqtabrarnsgrp, file = file.path("output/expected_losses", "freqtabrarnsgrp.rds"))
