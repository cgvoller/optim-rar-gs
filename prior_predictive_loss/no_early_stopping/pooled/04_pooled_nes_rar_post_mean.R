...
##
## 
# Simulate BRAR Pooled No early stopping ---------------------------------------
message("Simulate Bayesian RAR Pooled Loss NS - Posterior Mean")
...
print(bayestabrarnspl)
# saveRDS(bayestabrarnspl, file = file.path("output/expected_losses", "bayestabrarnspl.rds"))
